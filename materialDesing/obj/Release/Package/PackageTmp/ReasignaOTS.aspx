...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <h5>reasignacion de ots</h5>
            </div>
            <div class="row">
                <label>Num. de OTS:</label>
                <asp:TextBox ID="txtNumOTS" runat="server" CssClass="validate"></asp:TextBox>
            </div>
            <div class="row">
                <label>Tipo OTS:</label>
                <asp:TextBox ID="txtTipoOTS" runat="server" CssClass="validate"></asp:TextBox>
            </div>
            <div class="row">
                <label>Responsable:</label>
                <asp:TextBox ID="txtResponsable" runat="server" CssClass="validate"></asp:TextBox>
            </div>
            <div class="row">
                <label>Nuevo Responsable:</label>
                <asp:DropDownList ID="cmbResponsable" runat="server" CssClass="browser-default"></asp:DropDownList>
            </div>
            <div class="row">
                <asp:Button ID="btnReasignar" runat="server" Text="Reasignar" OnClick="btnReasignar_Click" />
            </div>
        </div>
    </form>
</body>
